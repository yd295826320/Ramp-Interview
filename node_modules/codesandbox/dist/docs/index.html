...
<head>
	...
	<title>codesandbox | codesandbox</title>
		...
		<div class="container">
			<div class="table-wrap">
				<div class="table-cell">
					<strong><a href="index.html">codesandbox</a></strong>
				</div>
...
<div class="container container-main">
	<div class="content-wrap">
		<div class="tsd-panel tsd-typography">
			<h1 id="typescript-library-starter">TypeScript library starter</h1>
			<p><a href="https://github.com/prettier/prettier"><img src="https://img.shields.io/badge/styled_with-prettier-ff69b4.svg" alt="styled with prettier"></a>
				<a href="https://greenkeeper.io/"><img src="https://badges.greenkeeper.io/alexjoverm/typescript-library-starter.svg" alt="Greenkeeper badge"></a>
				<a href="https://travis-ci.org/alexjoverm/typescript-library-starter"><img src="https://img.shields.io/travis/alexjoverm/typescript-library-starter.svg" alt="Travis"></a>
				<a href="https://coveralls.io/github/alexjoverm/typescript-library-starter"><img src="https://img.shields.io/coveralls/alexjoverm/typescript-library-starter.svg" alt="Coveralls"></a>
				<a href="https://david-dm.org/alexjoverm/typescript-library-starter?type=dev"><img src="https://david-dm.org/alexjoverm/typescript-library-starter/dev-status.svg" alt="Dev Dependencies"></a>
			<a href="https://paypal.me/AJoverMorales"><img src="https://img.shields.io/badge/donate-paypal-blue.svg" alt="Donate"></a></p>
			<p>A starter project that makes creating a TypeScript library extremely easy.</p>
			<h3 id="usage">Usage</h3>
			<pre><code class="lang-bash">git <span class="hljs-built_in">clone</span> https://github.com/alexjoverm/typescript-library-starter.git YOURFOLDERNAME
<span class="hljs-built_in">cd</span> YOURFOLDERNAME

<span class="hljs-comment"># Run npm install and write your library name when asked. That's all!</span>
npm install
</code></pre>
			<p><strong>Start coding!</strong> <code>package.json</code> and entry files are already set up for you, so don&#39;t worry about linking to your main file, typings, etc. Just keep those files with the same names.</p>
			<h3 id="features">Features</h3>
			<ul>
				<li>Zero-setup. After running <code>npm install</code> things will be setup for you :wink:</li>
				<li><strong><a href="https://rollupjs.org/">RollupJS</a></strong> for multiple optimized bundles following the <a href="http://2ality.com/2017/04/setting-up-multi-platform-packages.html">standard convention</a> and <a href="https://alexjoverm.github.io/2017/03/06/Tree-shaking-with-Webpack-2-TypeScript-and-Babel/">Tree-shaking</a>.</li>
				<li>Tests, coverage and interactive watch mode using <strong><a href="http://facebook.github.io/jest/">Jest</a></strong></li>
				<li><strong><a href="https://github.com/prettier/prettier">Prettier</a></strong> and <strong><a href="https://palantir.github.io/tslint/">TSLint</a></strong> for code formatting and consistency.</li>
				<li><strong>Docs automatic generation and deployment</strong> to <code>gh-pages</code>, using <strong><a href="http://typedoc.org/">TypeDoc</a></strong></li>
				<li>Automatic types <code>(*.d.ts)</code> file generation</li>
				<li><strong><a href="https://travis-ci.org">Travis</a></strong> integration and <strong><a href="https://coveralls.io/">Coveralls</a></strong> report</li>
				<li>(Optional) <strong>Automatic releases and changelog</strong>, using <a href="https://github.com/semantic-release/semantic-release">Semantic release</a>, <a href="https://github.com/commitizen/cz-cli">Commitizen</a>, <a href="https://github.com/conventional-changelog/conventional-changelog">Conventional changelog</a> and <a href="https://github.com/typicode/husky">Husky</a> (for the git hooks)</li>
			</ul>
			<h3 id="excluding-peerdependencies">Excluding peerDependencies</h3>
			...
			<p>The good news is here is setup for you, you only must include the dependency name in <code>external</code> property within <code>rollup.config.js</code>. For example, if you wanna exclude <code>lodash</code>, just write there <code>external: [&#39;lodash&#39;]</code>.</p>
			<h3 id="npm-scripts">NPM scripts</h3>
			<ul>
				<li><code>npm t</code>: Run test suite</li>
				<li><code>npm start</code>: Runs <code>npm run build</code> in watch mode</li>
				...
				<li><code>npm run build</code>: Generage bundles and typings, create docs</li>
			...
			<h3 id="automatic-releases">Automatic releases</h3>
			<p>If you&#39;d like to have automatic releases with Semantic Versioning, follow these simple steps.</p>
			<p><em><strong>Prerequisites</strong>: you need to create/login accounts and add your project to:</em></p>
			<ul>
				<li>npm</li>
				<li>Travis</li>
				<li>Coveralls</li>
			</ul>
			<p>Run the following command to prepare hooks and stuff:</p>
			<pre><code class="lang-bash">npm run semantic-release-prepare
</code></pre>
			<p>Follow the console instructions to install semantic release run it (answer NO to &quot;Generate travis.yml&quot;).</p>
			<p><em>Note: make sure you&#39;ve setup <code>repository.url</code> in your <code>package.json</code> file</em></p>
			<pre><code class="lang-bash">npm install -g semantic-release-cli
semantic-release setup
<span class="hljs-comment"># IMPORTANT!! Answer NO to "Generate travis.yml" question. Is already prepared for you :P</span>
</code></pre>
			<p>From now on, you&#39;ll need to use <code>npm run commit</code>, which is a convenient way to create conventional commits.</p>
			<p>Automatic releases are possible thanks to <a href="https://github.com/semantic-release/semantic-release">semantic release</a>, which publishes your code automatically on github and npm, plus generates automatically a changelog. This setup is highly influenced by <a href="https://egghead.io/courses/how-to-write-an-open-source-javascript-library">Kent C. Dodds course on egghead.io</a></p>
			<h3 id="git-hooks">Git Hooks</h3>
			<p>There is already set a <code>precommit</code> hook for formatting your code with Prettier :nail_care:</p>
			<p>By default, there are 2 disabled git hooks. They&#39;re set up when you run the <code>npm run semantic-release-prepare</code> script. They make sure:</p>
			<ul>
				<li>You follow a <a href="https://github.com/conventional-changelog/conventional-changelog">conventional commit message</a></li>
				<li>Your build is not gonna fail in <a href="https://travis-ci.org">Travis</a> (or your CI server), since it&#39;s runned locally before <code>git push</code></li>
			</ul>
			<p>This makes more sense in combination with <a href="#automatic-releases">automatic releases</a></p>
			<h3 id="faq">FAQ</h3>
			<h4 id="-array-prototype-from-promise-map-is-undefined-"><code>Array.prototype.from</code>, <code>Promise</code>, <code>Map</code>... is undefined?</h4>
			<p>TypeScript or Babel only provides down-emits on syntactical features (<code>class</code>, <code>let</code>, <code>async/away</code>...), but not on functional features (<code>Array.prototype.find</code>, <code>Set</code>, <code>Promise</code>...), . For that, you need Polyfills, such as <a href="https://github.com/zloirock/core-js"><code>core-js</code></a> or <a href="https://babeljs.io/docs/usage/polyfill/"><code>babel-polyfill</code></a> (which extends <code>core-js</code>).</p>
			<p>For a library, <code>core-js</code> plays very nicely, since you can import just the polyfills you need:</p>
			<pre><code class="lang-javascript"><span class="hljs-keyword">import</span> <span class="hljs-string">"core-js/fn/array/find"</span>
<span class="hljs-keyword">import</span> <span class="hljs-string">"core-js/fn/string/includes"</span>
<span class="hljs-keyword">import</span> <span class="hljs-string">"core-js/fn/promise"</span>
...
</code></pre>
			<h4 id="what-is-npm-install-doing-the-first-time-runned-">What is <code>npm install</code> doing the first time runned?</h4>
			<p>It runs the script <code>tools/init</code> which sets up everything for you. In short, it:</p>
			<ul>
				<li>Configures RollupJS for the build, which creates the bundles.</li>
				<li>Configures <code>package.json</code> (typings file, main file, etc)</li>
				<li>Renames main src and test files</li>
			</ul>
			<h4 id="what-if-i-don-t-want-git-hooks-automatic-releases-or-semantic-release-">What if I don&#39;t want git-hooks, automatic releases or semantic-release?</h4>
			<p>Then you may want to:</p>
			<ul>
				<li>Remove <code>commitmsg</code>, <code>postinstall</code> scripts from <code>package.json</code>. That will not use those git hooks to make sure you make a conventional commit</li>
				<li>Remove <code>npm run semantic-release</code> from <code>.travis.yml</code></li>
			</ul>
			<h4 id="what-if-i-don-t-want-to-use-coveralls-or-report-my-coverage-">What if I don&#39;t want to use coveralls or report my coverage?</h4>
			<p>Remove <code>npm run report-coverage</code> from <code>.travis.yml</code></p>
			<h2 id="credits">Credits</h2>
			<p>Made with :heart: by <a href="https://twitter.com/alexjoverm">@alexjoverm</a> and all these wonderful contributors (<a href="https://github.com/kentcdodds/all-contributors#emoji-key">emoji key</a>):</p>
			<!-- ALL-CONTRIBUTORS-LIST:START - Do not remove or modify this section -->
			<table>
				<thead>
					<tr>
						<th style="text-align:center"><a href="https://www.linkedin.com/in/ciro-ivan-agulló-guarinos-42109376"><img src="https://avatars.githubusercontent.com/u/6052309?v=3" width="100px;"/><br /><sub>Ciro</sub></a><br /><a href="https://github.com/alexjoverm/typescript-library-starter/commits?author=k1r0s" title="Code">💻</a> <a href="#tool-k1r0s" title="Tools">🔧</a></th>
						<th style="text-align:center"><a href="https://blog.mariusschulz.com"><img src="https://avatars.githubusercontent.com/u/947523?v=3" width="100px;"/><br /><sub>Marius Schulz</sub></a><br /><a href="https://github.com/alexjoverm/typescript-library-starter/commits?author=mariusschulz" title="Documentation">📖</a></th>
						<th style="text-align:center"><a href="https://github.com/alextrastero"><img src="https://avatars.githubusercontent.com/u/4152819?v=3" width="100px;"/><br /><sub>Alexander Odell</sub></a><br /><a href="https://github.com/alexjoverm/typescript-library-starter/commits?author=alextrastero" title="Documentation">📖</a></th>
						<th style="text-align:center"><a href="https://github.com/superamadeus"><img src="https://avatars1.githubusercontent.com/u/8728882?v=3" width="100px;"/><br /><sub>Ryan Ham</sub></a><br /><a href="https://github.com/alexjoverm/typescript-library-starter/commits?author=superamadeus" title="Code">💻</a></th>
						<th style="text-align:center"><a href="https://consiiii.me"><img src="https://avatars1.githubusercontent.com/u/8458838?v=3" width="100px;"/><br /><sub>Chi</sub></a><br /><a href="https://github.com/alexjoverm/typescript-library-starter/commits?author=ChinW" title="Code">💻</a> <a href="#tool-ChinW" title="Tools">🔧</a> <a href="https://github.com/alexjoverm/typescript-library-starter/commits?author=ChinW" title="Documentation">📖</a></th>
						<th style="text-align:center"><a href="https://github.com/mattmazzola"><img src="https://avatars2.githubusercontent.com/u/2856501?v=3" width="100px;"/><br /><sub>Matt Mazzola</sub></a><br /><a href="https://github.com/alexjoverm/typescript-library-starter/commits?author=mattmazzola" title="Code">💻</a> <a href="#tool-mattmazzola" title="Tools">🔧</a></th>
						<th style="text-align:center"><a href="http://leefrost.github.io"><img src="https://avatars0.githubusercontent.com/u/2664047?v=3" width="100px;"/><br /><sub>Sergii Lischuk</sub></a><br /><a href="https://github.com/alexjoverm/typescript-library-starter/commits?author=Leefrost" title="Code">💻</a></th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td style="text-align:center"><a href="http;//opendirective.com"><img src="https://avatars1.githubusercontent.com/u/618922?v=3" width="100px;"/><br /><sub>Steve Lee</sub></a><br /><a href="#tool-SteveALee" title="Tools">🔧</a></td>
						<td style="text-align:center"><a href="http://flaviocorpa.com"><img src="https://avatars0.githubusercontent.com/u/5127501?v=3" width="100px;"/><br /><sub>Flavio Corpa</sub></a><br /><a href="https://github.com/alexjoverm/typescript-library-starter/commits?author=kutyel" title="Code">💻</a></td>
						<td style="text-align:center"><a href="https://github.com/foreggs"><img src="https://avatars2.githubusercontent.com/u/22561997?v=3" width="100px;"/><br /><sub>Dom</sub></a><br /><a href="#tool-foreggs" title="Tools">🔧</a></td>
					</tr>
				</tbody>
			</table>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-external-module"><a href="modules/_actions_editor_.html" class="tsd-kind-icon">"actions/editor"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_actions_error_.html" class="tsd-kind-icon">"actions/error"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_actions_index_.html" class="tsd-kind-icon">"actions/index"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_actions_notifications_.html" class="tsd-kind-icon">"actions/notifications"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_actions_source_dependencies_.html" class="tsd-kind-icon">"actions/source/dependencies"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_actions_source_index_.html" class="tsd-kind-icon">"actions/source/index"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_actions_source_modules_.html" class="tsd-kind-icon">"actions/source/modules"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_codesandbox_.html" class="tsd-kind-icon">"codesandbox"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_dispatcher_host_.html" class="tsd-kind-icon">"dispatcher/host"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_dispatcher_index_.html" class="tsd-kind-icon">"dispatcher/index"</a></li>
						</ul>
					</section>
				</div>
			</section>
